...
import simpleDelegator5.core.view.delegator.NamedComponentsDelegator;
import simpleDelegator5.core.view.delegator.ViewContainerControllerDelegator;
...
public abstract class AbstractViewContainer implements ViewContainer
{
	...
	public List<Component> getComponentsByName(String name) {
		...
		logger.info("this.getNamedComponents():"+this.getNamedComponents());
